...
public class LivroController {
    ...
    public ResponseEntity<Void> cadastrar(
        ...
        log.info("POST /livros - cadastrar titulo={}", dto.titulo());
        serviceI.criar(dto, capaDoLivro);
        log.info("Livro cadastrado: titulo={}", dto.titulo());
    ...
    public ResponseEntity<Page<LivroCardResponse>> buscar(@RequestParam(required = false) String titulo,
            ...
            Pageable pageable) {
        log.info("GET /livros - buscar titulo={} editora={} autor={}", titulo, editora, autor);
    ...
    ResponseEntity<Page<LivroResponse>> listarPopulares() {
        log.info("GET /livros/populares - listar populares");
    ...
    public ResponseEntity<LivroResponse> buscar(@PathVariable String isbn) {
        log.info("GET /livros/buscar/{} - buscar por isbn", isbn);
    ...
    public ResponseEntity<byte[]> buscarCapa(@PathVariable Long id) {
        log.info("GET /livros/{}/capa - buscar capa", id);
    ...
    public ResponseEntity<Void> inserirCapa(
        ...
        log.info("PUT /livros/{}/capa - inserir/atualizar capa", id);
