...
class UsuarioControllerTest {
    ...
    void deveCriarUmUsuarioComSucesso() throws Exception {
        ...
        when(service.criar(any(UsuarioRequestDto.class), any(MultipartFile.class), any(HttpServletResponse.class)))
                .thenReturn(response);
        ...
        verify(service).criar(any(UsuarioRequestDto.class), any(MultipartFile.class), any(HttpServletResponse.class));
    }
